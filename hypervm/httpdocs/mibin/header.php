...
function createHeaderData()
{
	...
	if ($login->isClass('vps')) {
		$lxclienturl = kloxo::generateKloxoUrl($login, null, "a=list&c=client");
		$lxdomainurl = kloxo::generateKloxoUrl($login, null, "a=list&c=all_domaina");
	}
	...
	$gdata = array(
		...
		"vps" => array($vpsdesc, "/display.php?frm_action=list&frm_o_cname=$vpsclass", "vps_list.gif"),
		...
		"lxclient" => array($clientdesc, $lxclienturl, "client_list.gif"),
		"lxdomain" => array($clientdesc, $lxdomainurl, "client_list.gif"),
