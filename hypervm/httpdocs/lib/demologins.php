...
foreach($res as $k => $v) {
	...
	print(" <tr> <td ><img width=20 height=20 src=/img/general/button/on.gif> </td> <td ><a href=http://lxcenter.org/ target='_blank'> Visit lxcenter.org</a> </td></tr>");
	print(" <tr> <td ><img width=20 height=20 src=/img/general/button/on.gif> </td> <td ><a href=http://wiki.lxcenter.org/ target='_blank'> Visit the Wiki</a> </td></tr>");
print("</table>");
