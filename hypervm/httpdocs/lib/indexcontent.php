...
<table align=center cellpadding=0 cellspacing=0 border=0 width=314>
	<tr>
		<td><img src="/img/generic-login.gif"></td>
	</tr>
	<tr>
		<td background="/img/login_02.gif">
		<form name=loginform action="/htmllib/phplib/"
			onsubmit="return fieldcheck(this);" method=get>
		...
		<table cellpadding=2 cellspacing=2 border=0 width=100%>
			...
			<tr>
				<td width=20></td>
				<td><font name=Verdana size=2 color=#3992DE><b>Username</b></font></td>
				<td><input type=text name=frm_clientname size=30 class=logintextbox>
				</td>
			</tr>
			<tr>
				<td width=20></td>
				<td><font name=Verdana size=2 color=#3992DE><b>Password</b></font></td>
				<td><input type=password name=frm_password size=30
					class=logintextbox></td>
			</tr>
		...
		<table cellpadding=0 cellspacing=0 border=0 bgcolor=#ddf2fb width=100%>
			<tr>
				<td width=30></td>
				<td width=150><a class=forgotpwd
					href="javascript:document.forgotpassword.submit()">Forgot Password?</a></td>
				<td align=right><input name=login type=image src="/img/loginbtn.gif"
					onMouseOver="swapImage('login','','/img/loginbtn_1.gif',1);"
					onMouseOut="swapImgRestore();"></td>
				<td width=20></td>
			</tr>
		</table>
		</form>
	...
	<tr>
		<td><img src="img/login_03.gif"></td>
	</tr>
</table>
<form name="forgotpassword" method="post" action="/"><input
	type="hidden" name=frm_forgotpwd value="1"></form>
...
<table align=center cellpadding=0 cellspacing=0 border=0 width=314>
	<tr>
		<td><img src="/img/forgot_01.gif"></td>
	</tr>
	<tr>
		<td background="/img/forgot_02.gif">
		<form name=sendmail action="<?php echo $_SERVER['PHP_SELF']; ?>"
			method="post">
		<table cellpadding=2 cellspacing=2 border=0 width=100%>
			<tr>
				<td width=20 height=10></td>
			...
			<tr>
				<td width=20></td>
				<td><font name=Verdana size=2 color=#3992DE><b>Username</b></font></td>
				<td><input type=text name=frm_clientname size=30 class=forgottextbox>
				</td>
			</tr>
			<tr>
				<td width=20></td>
				<td><font name=Verdana size=2 color=#3992DE><b>Email Id</b></font></td>
				<td><input type=text name=frm_email size=30 class=forgottextbox></td>
			</tr>
		...
		<table cellpadding=0 cellspacing=0 border=0 width=100%>
			<tr>
				<td width=30></td>
				<td width=150><a class=forgotpwd href="javascript:history.go(-1);">Back
				to login</a></td>
				<td align=right><input name=forgot type=image
					src="/img/forgotbtn.gif"
					onMouseOver="swapImage('forgot','','/img/forgotbtn_1.gif',1);"
					onMouseOut="swapImgRestore();"></td>
				<td width=20></td>
			</tr>
		</table>
		<input type="hidden" name="frm_forgotpwd" value="2"></form>
		</td>
	</tr>
	<tr>
		<td><img src="/img/forgot_03.gif"></td>
	</tr>
</table>
