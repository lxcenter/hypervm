...
function api_main()
{
	...
	?>
<input type=hidden
	name=login-class value=client>
<input type=hidden
	name=login-name value=admin>
<input type=hidden
	name=login-password value=hell>
<input type=hidden name=action
	value=add>
<input type=hidden name=class
	value=vps>
<input type=hidden
	name=v-type value=openvz>
Vps Type: openvz
<br>
Vps name:
<br>
...
<br>
<input type=text
	name=v-num_ipaddress_f value=>
<br>
Contact Email
<br>
<input type=text
	name=v-contactemail value=>
<br>
Password
<br>
<input type=text name=v-password
	value=>
<br>
	<?php
